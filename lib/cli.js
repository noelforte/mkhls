...
const program = new Command()
	...
	.option(
		'--timeline-preview-vtt-prefix <path>',
		'Optional prefix to prepend URLs in the preview VTT file with (either a address or root folder path)',
		''
	)

	// Generic options
	.option(
		'--preserve-cwd-structure <root>',
		'If set, constructs the output directories using the path of the input file, relative to process.cwd'
	)
	.option(
		'--count-frames',
