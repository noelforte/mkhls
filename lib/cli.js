...
const program = new Command()
	...
	.option(
		'--output-prefix <path>',
		'An optional prefix to prepend to the output files, is relative to output directory',
		''
	)
	...
	.option(
		...
		'If set, constructs the output directories using the path of the input file, relative to the current directory'
	)
	.option(
		'--count-frames',
